...
- [ ] **Checkpoint 2: OSU Design System & Component Library** (Scarlet & Grey palette, MacroRing, ProgressBar)
- [ ] **Checkpoint 3: Campus Dining & Nutrislice Catalog** (Live API client, 10+ OSU venues, macro normalizer)
